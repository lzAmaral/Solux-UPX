...
const AdminLayout = ({ children }) => {
  ...
  const navigation = [
    ...
    { name: 'Usinas', href: '/admin/usinas', icon: Factory },
    { name: 'Unidades', href: '/admin/unidades', icon: Zap },
    { name: 'Geração', href: '/admin/geracao', icon: BatteryCharging },
    { name: 'Rateios', href: '/admin/rateios', icon: PieChart },
    { name: 'Exportações', href: '/admin/exportacoes', icon: Download },
